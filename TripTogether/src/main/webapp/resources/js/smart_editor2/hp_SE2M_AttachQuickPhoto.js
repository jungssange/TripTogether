...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	 ...
	 */
	makePopupURL : function(idname){
	
		//var sPopupUrl = "./sample/photo_uploader/photo_uploader.html";
		//var sPopupUrl = "../smart_editor2/photo_uploader.html";
		var currentPage = document.location.href; 
		//currentPage = currentPage.slice(7);     
		tmpurl = currentPage.split("/"); 
		url = tmpurl[0] + "//" + tmpurl[2] + "/" + tmpurl[3];

		
		var sPopupUrl = url + "/photoUploader.dmn?idname="+idname;
