	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				linkNode.href = '../../css/smart_editor2_in.css';
...
nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
	...
	addAllFonts : function(){
		...
		if(!this.htOptions || !this.htOptions.aDefaultFontList || this.htOptions.aDefaultFontList.length === 0){
			...
			this.addFont("나눔명조,NanumMyeongjo",          "나눔명조", 0, "", "", 1, null, true);
			this.addFont("나눔고딕코딩,NanumGothicCoding", "나눔고딕코딩", 0, "", "", 1, null, true);
			this.addFont("나눔바른고딕,NanumBarunGothic",  "나눔바른고딕", 0, "", "", 1, null, true);
			this.addFont("나눔바른펜,NanumBarunPen",       "나눔바른펜", 0, "", "", 1, null, true);
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		nhn.husky.SE2M_Utils.loadCSS("../../css/smart_editor2_items.css", fnCallback);
