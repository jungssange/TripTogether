...
xq.plugin.FileUploadPlugin = xq.Class(xq.plugin.Base,
	...
	onAfterLoad: function(xed) {
		...
		xed.handleFileUpload = function(isSingleFileUpload) {
			...
			this.isSingleFileUpload = false;//by gu : isSingleFileUpload || !DetectFlashVer(requiredMajorVersion, requiredMinorVersion, requiredRevision);
			...
			load: function(dialog){
				if (xed.isSingleFileUpload){
					...
					*/ 
					...
					var settings = {
						flash_url : "js/xquared/javascripts/plugin/swfupload/swfupload.swf",
